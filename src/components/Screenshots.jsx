...
export default function Screenshots() {
    ...
    return (
        <section ref={sectionRef} id="screenshots" className="relative py-24 sm:py-32">
            {/* Ambient glow */}
                        ...
                        <div className="flex gap-2">
                            {screenshots.map((_, i) => (
                                <button
                                    ...
                                    className={`w-2 h-2 rounded-full transition-all ${i === current ? 'bg-neon-cyan w-6' : 'bg-white/20 hover:bg-white/40'
                                        }`}
                                />
                            ))}
                        </div>
